...
# Filtrar el DataFrame principal para considerar solo a partir de 2019
df = df[df["Year"] >= 2019]
...
# Manejo de caso borde si la base de datos solo llega hasta 2019 o menos
...
promedio_citas = filtered_df["Cited by"].mean() if total_publicaciones > 0 else 0
...
if not filtered_df.empty:
    ...
    st.info("No hay publicaciones en el rango seleccionado para graficar.")
...
# Solo renderizamos si las columnas existen en el DataFrame original
